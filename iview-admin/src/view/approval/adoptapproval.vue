    ...
    <Modal
        ...
        <Form ref="form" :model="editform" :rules="formValidate" :label-width="80">
          ...
          <FormItem style="text-align:center">
            <Button type="primary" @click="handleSubmit('form','审批通过')">审核通过</Button>
            <Button type="error" @click="handleSubmit('form','审批未通过')" style="margin-left: 8px">审核不通过</Button>
          </FormItem>
        </Form>
    </Modal>
  </div>
