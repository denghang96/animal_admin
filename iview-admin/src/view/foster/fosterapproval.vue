<template>
  <div>
    ...
    <Modal
        ...
        title="宠物到店">
          <p style="color:red">
            *宠物到店后，会在动物信息中增加一条简单的动物基本信息，您可以前往动物管理页面维护
          </p>
          <Input v-model="arriveform.animalNo"  placeholder="请输入宠物编号" required></Input>
          <DatePicker type="date" format="yyyy-MM-dd" placeholder="选择开始计费日期" v-model="arriveform.arriveDate" @on-change="getDate1"></DatePicker>
    </Modal>
